...
public class InitScreenHandler implements RegistryInitializer {
    ...
    public void register() {
        Registry.register(Registries.SCREEN_HANDLER, Dialabs.id("enchantment_synthesis_screen_handler"), ENCHANT_SYNTHESIS);
        Registry.register(Registries.SCREEN_HANDLER, Dialabs.id("disc_burner_screen_handler"), DISC_BURNER);
    }
